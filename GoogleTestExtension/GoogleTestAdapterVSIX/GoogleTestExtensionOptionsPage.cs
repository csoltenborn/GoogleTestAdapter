...
namespace GoogleTestAdapterVSIX
{
    ...
    public sealed class GoogleTestExtensionOptionsPage : Package
    {
        ...
        private RunSettings GetRunSettingsFromOptionPages()
        {
            ...
            runSettings.UserDebugMode = generalOptions.UserDebugMode;
    ...
    public class GeneralOptionsDialogPage : NotifyingDialogPage
    {
        ...
        public bool UserDebugMode
        {
            get { return userDebugMode; }
            set { SetAndNotify(ref userDebugMode, value); }
        }
        private bool userDebugMode = Options.OptionUserDebugModeDefaultValue;
